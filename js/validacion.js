function validar() {
    ...
    return retorno_nombre && retorno_comuna && retorno_correo && retorno_contra && retorno_contra2
...
function validar_URL() {
    ...
    if (valido) {
        ...
        div_error_url.innerHTML = "El url es obligatorio(Ejemplo: www.google.com)";
